...
const GameProvider = ({ children }) => {
    ...
    const selectLevel = (l: number) => {
        switch (l) {
            case 1: return { sizeBlock: 48, speed: 4 }
            case 2: return { sizeBlock: 40, speed: 4 }
            case 3: return { sizeBlock: 30, speed: 3 }
            case 4: return { sizeBlock: 24, speed: 4 }
            default: return { sizeBlock: 20, speed: 4 }
        }
    }
