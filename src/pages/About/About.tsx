            ...
            <div className="w-full flex flex-col-reverse sm:flex-row justify-center">
                <div className="max-w-xl min-h-[200px] p-2 flex flex-col justify-center content-center">
                    ...
                    <div className="flex-shrink-0 mb-4 bg-[--color-4] w-full block sm:hidden rounded-xl">
                        <img className="w-[175px] h-52 sm:w-48 object-cover object-top mx-auto bg-[--color-4] rounded-xl sm:rounded-3xl transform transition hover:scale-110 duration-700 ease-in-out" src={Photo} alt="Event image" />
                    </div>
                ...
                <div className="flex-shrink-0 hidden sm:block">
                    <img className="w-32 sm:w-48 object-cover mx-auto sm:bg-[--color-4] rounded-xl sm:rounded-3xl transform rotate-12 transition hover:scale-110 duration-700 ease-in-out hover:rotate-6" src={Photo} alt="Event image" />
                </div>
            </div>
        </div>
